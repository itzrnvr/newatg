...
export const getVideoSlider = baseUrl + 'get_video_slider';
export const saveUserProfile = baseUrl + 'put_user_profile';
export const getPrivacyPolicy = baseUrl + 'get_privacy_policy';
export const getPackages = baseUrl + 'get_packages';
export const getSerailKeyStatus = baseUrl + 'serial_key_status';
export const getSerialKeyList = baseUrl + 'serial_key_list';
